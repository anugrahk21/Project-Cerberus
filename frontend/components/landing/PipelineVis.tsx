        ...
        <div className="max-w-5xl mx-auto flex flex-col items-center">
          ...
          <div className="relative w-full h-16 mt-2 mb-2">
             ...
             <motion.div 
               ...
               className="absolute top-full left-1/4 right-1/4 h-px bg-white/20"
             />
             ...
             <motion.div 
               ...
               className="absolute top-full left-[25%] w-px bg-white/20"
             />
             <motion.div 
               initial={{ height: 0 }}
               whileInView={{ height: "20px" }}
               viewport={{ once: true }}
               transition={{ duration: 0.3, delay: 2.3 }}
               className="absolute top-full right-[25%] w-px bg-white/20"
             />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full mt-6">
            {/* Blocked Path */}
            <Step delay={2.5}>
              <div className="border border-red-900/30 bg-red-950/10 p-6 rounded-xl h-full">
            ...
            {/* Approved Path */}
            <Step delay={2.7}>
              <div className="border border-green-900/30 bg-green-950/10 p-6 rounded-xl h-full">
...
function Connector({ delay = 0 }: { delay?: number }) {
  return (
    <motion.div
      ...
      className="w-px bg-white/20 my-2"
    >
